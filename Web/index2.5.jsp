...
<meta charset="ISO-8859-1">
    <title>Shifting History by AssetID</title>
    
    <link rel="stylesheet" href="design2.5.css">
...
<div class="homepage">
      ...
      <form action="AuditorActionServ" method="post" target="_blank">
        <div class="inputBox">
           ...
           <div class="sub">
   <input type="submit" class="button" name="func" value="ViewByAssetID">
