...
<title>Add Multiple Assets</title>
    ...
    <link rel="stylesheet" href="design1.3.css">
...
<div class="homepage">
  ...
  <div class="box">
	  ...
	  <input list="Name" name="asset" required size="4">
 		<datalist id="Name"  >
 		<%
 		try {
 		...
 		%>
          ...
          <input type="number" name="count" max="100" min="0" ="" required name="count">
           ...
           <div class="sub">
   <input type="submit" class="button" name="func" value="Add">
