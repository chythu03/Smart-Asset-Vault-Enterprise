...
<link rel="stylesheet" href="design1.9.css">
 ...
 <div class="homepage">
       <div class="menu">
        ...
        <ul id="navmenu">
            ...
            <li><a href="AdmiCreate.jsp"><i class="fa fa-plus" aria-hidden="true"></i> Create</a></li>
            ...
            <li><a href="Logout.jsp"><i class="fa fa-sign-out" aria-hidden="true"></i>Logout</a>
             ...
             <div class="box">
                 <h2>View Shift History by StaffId</h2>
      <form action="Action" method="post" target="_blank">
        <div class="inputBox">
           ...
           <div class="sub">
  <input type="submit" class="button" name="func" value="ViewByStaffID">
