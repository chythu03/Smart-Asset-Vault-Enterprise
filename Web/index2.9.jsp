...
<meta charset="ISO-8859-1">
    <title>Report by AssetID</title>
    
    <link rel="stylesheet" href="design2.9.css">
...
<div class="homepage">
      ...
      <form action="AuditorActionServ" method="post" target="_blank">
        <div class="inputBox">
           ...
           <div class="sub">
   <input type="submit" class="button" name="func" value="ReportByAssetID">
