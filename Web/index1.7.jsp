...
<title>Shifting History by Date</title>
    
    <link rel="stylesheet" href="design1.7.css">
...
<body>
 <div class="homepage">
	...
	<label for="FrDt">From Date</label>
	 ...
	 <div class="sub">
   <input type="submit" class="button" name="func" value="ViewByDate">
