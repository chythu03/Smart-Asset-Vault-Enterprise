...
<link rel="stylesheet" href="design1.1.css">
...
<div class="container">
    ...
    <input type="text" id="prod" name="assetname" placeholder="Asset name.." required>
    </div>
<div class="subgroup">
  ...
  <div class="sub">
	...
	<input type="submit" class="button" name="func" value="create">
    </div>
    </form>
</div>
